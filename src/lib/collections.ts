...
export const COLLECTIONS: Collection[] = [
  ...
  },
  {
    ...
    label: 'Photographs',
    singular: 'photograph',
    description: 'Every image in the gallery. Photographs sent in by visitors wait here for approval.',
    group: 'Content',
    moderated: true,
    orderBy: "(status = 'pending') DESC, sort_order, id",
    titleField: 'caption',
    subtitleFields: ['album', 'submitted_by'],
    fields: [
      { name: 'url', label: 'Photograph', type: 'image', required: true },
      { name: 'caption', label: 'Caption', type: 'text' },
      STATUS,
      { name: 'submitted_by', label: 'Sent in by', type: 'text', half: true },
