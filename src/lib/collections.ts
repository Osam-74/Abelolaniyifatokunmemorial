...
export const COLLECTIONS: Collection[] = [
  ...
  },
  {
    ...
    label: 'Tributes',
    singular: 'tribute',
    description: 'Messages sent by visitors. Nothing appears publicly until you approve it.',
    group: 'Moderation',
    orderBy: "(status = 'pending') DESC, created_at DESC",
    moderated: true,
    titleField: 'name',
    subtitleFields: ['relationship', 'location'],
    fields: [
  ...
  },
  {
    ...
    label: 'Stories',
    singular: 'story',
    description: 'Longer memories sent by visitors, and stories you write yourself.',
    group: 'Moderation',
    orderBy: "(status = 'pending') DESC, created_at DESC",
    moderated: true,
    titleField: 'title',
  ...
  },
  {
    ...
    label: 'Guestbook',
    singular: 'entry',
    description: 'Signatures and short messages. Approve each one to publish it.',
    group: 'Moderation',
    orderBy: "(status = 'pending') DESC, created_at DESC",
    moderated: true,
    titleField: 'name',
  ...
  },
  {
    ...
    label: 'Candles',
    singular: 'candle',
    description: 'Candles light immediately. Reject any that are not right.',
    group: 'Moderation',
